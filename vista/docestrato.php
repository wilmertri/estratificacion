...
$txt1 = "\n         Cédula catastral Nº:        ".$consdat[0]['codcas']."\n         Dirección:                        ".$consdat[0]['dirpred'].".";
$txt2 = "Esta consulta es únicamente informativa, si requiere un Certificado de Estrato, por favor acercarse a la Oficina de Archivo y Correspondencia, ubicada en el Edificio de Planeación (carrera 11 No. 11-65, Parque Santander), para diligenciar la solicitud.
...
$txt4 = "191(".$consdat[0]['radent'].")                                                                                           DPD-15";
$txt5 = "ASUNTO:";
